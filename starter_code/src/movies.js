...
function convertDuration(duration) {
  ...
  var minutes = timePieces.reduce(function(sum, onePiece) {
...
function turnHoursToMinutes(movies) {
  var newCentArray = movies.map(function(oneMovie) {
    var newMovie = {};
...
function ratesAverage(movies) {
  var rateSum = movies.reduce(function(sum, oneMovie) {
...
function bestYearAvg(movies) {
  ...
  var winner = Object.keys(movieYears)
